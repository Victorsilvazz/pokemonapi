    ...
    return (
        <div className="flex items-center gap-4 bg-white/60 border border-amber-800/10 px-4 py-3 mb-3">
            ...
            <div className="flex-1">
                ...
                <span className={`${getTypeColors(type)} text-white text-xs px-2.5 py-1 rounded-full uppercase inline-block mt-1`}>
                    {type}
                </span>
            </div>
        ...
        <button onClick={() => onRemove(pokemon.name)} className="hover:opacity-70 transition-opacity">
